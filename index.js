...
document.addEventListener('DOMContentLoaded', () => {
  const hoverAnimationTriggerList =
      [].slice.call(document.querySelectorAll('[data-bss-hover-animate]'));
  hoverAnimationTriggerList.forEach((hoverAnimationEl) => {
    hoverAnimationEl.addEventListener('mouseenter', (e) => {
      e.target.classList.add('animated', e.target.dataset.bssHoverAnimate);
    });
    hoverAnimationEl.addEventListener('mouseleave', (e) => {
